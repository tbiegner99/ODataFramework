...
public class SQLiteDialect extends Dialect {
	 ...
	 * StringBuffer(insertString.length()+30). // As specified in NHibernate dialect append(insertString).
	...
	/*
	 * @Override public boolean dropTemporaryTableAfterUse() { return true; // temporary tables are only dropped when
	 * the connection is closed. If the connection is pooled... }
	 */
